...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=${FOLLOWUP} python -m evaluation.inference_shotgun \
            ...
            --answer-file data/shotgun_${MAX_QUERY_LEN}_cr${CHAIN_RESERVE_LEN}_answer/${MODEL_NAME}-shotgun-${torch_dtype}-p${PREFIX}-f${FOLLOWUP}-cr${CHAIN_RESERVE_LEN}.jsonl \
